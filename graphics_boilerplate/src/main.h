...
extern const color_t COLOR_CREAMBLUE;
extern const color_t COLOR_WHITEPURPLE;
extern const color_t COLOR_REDRAINBOW;
extern const color_t COLOR_ORANGERAINBOW;
extern const color_t COLOR_GREENRAINBOW;
extern const color_t COLOR_BLUERAINBOW;
